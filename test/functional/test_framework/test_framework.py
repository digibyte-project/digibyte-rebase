...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def add_nodes(self, num_nodes: int, extra_args=None, *, rpchost=None, binary=None, binary_cli=None, versions=None):
        ...
        if binary is None:
            binary = [get_bin_from_version(v, 'digibyted', self.options.bitcoind) for v in versions]
        if binary_cli is None:
            binary_cli = [get_bin_from_version(v, 'digibyte-cli', self.options.bitcoincli) for v in versions]
