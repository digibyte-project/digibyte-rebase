...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def test_dump_createfromdump(self):
        ...
        assert_equal(dump_data['DGBCOIN_CORE_WALLET_DUMP'], '1')
        ...
        dump_data["DGBCOIN_CORE_WALLET_DUMP"] = "0"
        ...
        dump_data["DGBCOIN_CORE_WALLET_DUMP"] = "2"
        self.write_dump(dump_data, bad_ver_wallet_dump)
        ...
        del dump_data["DGBCOIN_CORE_WALLET_DUMP"]
        dump_data["not_the_right_magic"] = "1"
        self.write_dump(dump_data, bad_magic_wallet_dump, "not_the_right_magic")
        self.assert_raises_tool_error('Error: Dumpfile identifier record is incorrect. Got "not_the_right_magic", expected "DGBCOIN_CORE_WALLET_DUMP".', '-wallet=badload', '-dumpfile={}'.format(bad_magic_wallet_dump), 'createfromdump')
        assert not os.path.isdir(os.path.join(self.nodes[0].datadir, "regtest/wallets", "badload"))
